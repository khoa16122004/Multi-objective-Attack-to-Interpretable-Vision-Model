...
python run_nsgaii_sparse_test.py \
    --image test_imgs/dog_human.png \
    --max-query 10000 \
    --n-pix 500 \
    --pop-size 100 \
    --intersec-mode auto_low_region \
    --explain-method simple_gradient \
    --out-dir results_auto_low_region/simple_gradient
...
python run_nsgaii_sparse_test.py \
    ...
    --out-dir results_auto_low_region/integrated_gradients
...
python run_nsgaii_sparse_test.py \
    ...
    --out-dir results_auto_low_region/grad_cam



# python evaluate.py \
#     --models resnet18 resnet50 vgg16 vgg19 densenet121 densenet169 vit_b_16 vit_b_32 \
#     --batch-size 512 \
#     --output-dir model_evaluation_results
